...
app.use('/css',express.static(__dirname + '/css',{ cache:true}));
app.use('/js',express.static(__dirname + '/js',{ cache:true}));
app.use('/Styles',express.static(__dirname + '/Styles',{ cache:true}));
